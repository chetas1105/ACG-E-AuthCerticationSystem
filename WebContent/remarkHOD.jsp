...
<%
	String str = (String)request.getAttribute("roll");
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 profiel-container">
                    ...
                    <form action="SendRemarkHOD" method="POST">
						<input id="hid" name="ro" type="hidden" value="<%= request.getAttribute("roll") %>">
                        <div class="profiel-header">
                            <h3>
                                <b>Enter the remark for rejection</b>
                            </h3>
                            <hr>
                        </div>
                        ...
                        <div class="clear">!
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="userid" name="remarkDetails">
                                </div>
