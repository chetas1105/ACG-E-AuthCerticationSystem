                    ...
                    <div class="col-md-12 col-xs-12 login-blocks">
                        ...
                        <form action="HODLogin" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="userid" name="HodUserID">
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" id="password" name = "HodPassword">
                            </div>
                            <div class="forgot">
                                <a href="forgotPasswordHOD.jsp">Forgot Password ?</a>
                            </div>
